...
import { CalendarDays, FileSpreadsheet, MapPin, Upload, Users } from 'lucide-react';
  ...
  return (
    <section className="space-y-5 pb-10 md:space-y-6">
      ...
      <StaggerSection className="glass rounded-xl p-4">
        ...
        <p className="mb-3 text-xs text-[var(--text-secondary)]">Upload CSV here to update events and volunteer matching data instantly.</p>
